      ...
      {factors.map((factor) => {
        ...
        return (
          <div key={factor.name} className="flex min-w-0 items-start gap-2 sm:items-center sm:gap-4">
            <div className="w-28 shrink-0 text-sm leading-snug text-white/80 sm:w-40 sm:text-base">
            ...
            <div className="relative min-w-0 flex-1">
              <div className="h-3 overflow-hidden rounded-full bg-white/85 sm:h-3.5 lg:h-4">
                <div
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#d1d5db] text-sm font-semibold text-[#0b2447] shadow-sm sm:h-9 sm:w-9 sm:text-base">
                  {currentValue}
                </div>
              </div>
            </div>

            <div className="w-9 shrink-0 text-right text-sm text-white/70 sm:w-10 sm:text-base">
              {factor.max}
            </div>
          </div>
        );
