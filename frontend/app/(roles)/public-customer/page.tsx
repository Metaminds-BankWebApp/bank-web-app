        ...
        >
           <div className="flex h-full flex-col justify-center px-24 py-12 pl-48">
              <div className="flex flex-col gap-6">
                {[
                  { title: "SpendIQ", subtitle: "Understand where your money goes.", href: "/public-customer/spendiq" },
                  { title: "CreditLens", subtitle: "Connecting your credit reality", href: "/public-customer/creditlens" },
                ].map((item) => (
