  ...
  useEffect(() => {
    ...
    const loadReport = async () => {
      try {
        setIsLoading(true);
        setError(null);
        const report = await getBankCreditReport();
        const mappedSnapshots = mapReportSnapshots(report);
    ...
    <div className="w-full min-h-[calc(100dvh-1.25rem)] space-y-4 overflow-x-hidden px-1 pt-2 sm:space-y-5 sm:px-2 lg:min-h-[calc(100dvh-2rem)] lg:px-6 lg:pt-4 xl:px-8 2xl:px-10">
      ...
      {isLoading && !current ? (
        ...
        <>
          <div className="pb-6 pt-1 sm:pb-8 lg:px-2 xl:px-3">
            ...
            <div className="mt-6 text-center text-xs text-slate-400">
              This report is generated based on bank officer provided financial data and system rules.
        ...
        <StateCard
          ...
          description="Once your CreditLens evaluation history is available, your report snapshots will appear here."
        />
      )}
    </div>
  );
