...
import { getBankCreditInsights } from "@/src/api/creditlens/bank-creditlens.service";
import type { CreditInsightsResponse } from "@/src/types/dto/bank-creditlens.dto";
...
export default function InsightPage() {
  ...
  const loadInsights = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const response = await getBankCreditInsights();
      ...
      <div className="pb-0 pt-1 sm:pt-2 lg:px-2 xl:px-3">
        {isLoading && !insights ? (
          ...
          <StateCard
            ...
            description="Your CreditLens insight cards will appear after the latest evaluation is available."
          />
        )}
      </div>
    </div>
