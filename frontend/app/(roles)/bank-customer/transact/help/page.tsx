  ...
  return (
    <div className="min-h-screen bg-transparent px-1 pt-2 sm:px-2 lg:px-6 lg:pt-4 xl:px-8 2xl:px-10">
      ...
      <main className="max-w-5xl mx-auto p-6">
        ...
        <section className="transact-card transact-card-hover transact-creditlens-shade creditlens-delay-2 mb-6 rounded-[20px] p-6">
          ...
          <div className="creditlens-stagger-2 mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="transact-card transact-card-hover transact-creditlens-shade col-span-2 rounded-md p-4">
            ...
            <div className="transact-card transact-card-hover transact-creditlens-shade rounded-md p-4">
