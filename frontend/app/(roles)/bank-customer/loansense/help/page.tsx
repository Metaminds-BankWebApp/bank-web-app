...
export default function LoanSenseCustomerHelp(){
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] p-4 font-sans text-slate-800 md:p-8">
...
function FeatureHelp({ title, description, faqs, troubleshooterOptions, openTicket, includeLoanInput }: { title: string; description: string; faqs: string[]; troubleshooterOptions: { key: string; label: string }[]; openTicket: () => void; includeLoanInput?: boolean }){
