...
export default function Page() {
  ...
  return (
    <main className="flex flex-col gap-6 p-4 md:p-8 min-h-screen bg-white font-sans text-slate-800">
       ...
       {/* Header */}
        <ModuleHeader theme="loansense" menuMode="feature-layout" title="Personal Loan" />
        <div><p className="text-sm opacity-80 mt-2">Discover your personal loan eligibility and affordability insights</p></div>
      ...
      <section className="rounded-xl bg-white p-6 shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <SummaryCard label="Max Eligible Amount" value="LKR 2,150,000" variant="dark" />
          <SummaryCard label="Recommended Tenure" value="12-36 months" variant="dark" />
          <SummaryCard label="Estimated EMI Range" value="LKR (45,000 - 88,000)" variant="light" />
          <SummaryCard label="Interest" value="17.0%" variant="light" />
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-xl bg-white p-6 shadow-md">
          ...
          <div className="space-y-1">
            <BreakdownRow label="Monthly Income" value="LKR 150,000" />
            <BreakdownRow label="Existing Loan EMIs" value="- LKR 15,000" tone="negative" />
