            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6">
                  <div>
                    <label className="block text-xs font-semibold mb-2"> BRANCH NAME <span className="text-red-600">*</span></label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold mb-2"> CONTACT NUMBER <span className="text-red-600">*</span></label>
                    <input
                      type="text"
                    ...
                    {errors.contact ? (
                     ...
                     <div>
                    <label className="block text-xs font-semibold mb-2">EMAIL ADDRESS <span className="text-red-600">*</span> </label>
                    <input
                      type="email"
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6">
                  ...
                  <div>
                    <label className="block text-xs font-semibold mb-2"> FULL ADDRESS <span className="text-red-600">*</span></label>
                    <textarea
