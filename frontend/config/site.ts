  ...
  sidebar: {
    ...
    BANK_OFFICER: {
      ...
      items: [
        ...
        { title: "Customer Lookup", href: "/bank-officer/all-customers", icon: "users", section: "general" },
        { title: "Add Customer", href: "/bank-officer/add-customer", icon: "user", section: "general" },
        { title: "Work Queue", href: "/bank-officer/work-queue", icon: "inbox", section: "general" },
        { title: "Credit Review", href: "/bank-officer/credit-analysis", icon: "line-chart", section: "general" },
